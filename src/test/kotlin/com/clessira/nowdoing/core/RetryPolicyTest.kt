...
class RetryPolicyTest {
    ...
    fun `transient HTTP statuses and transport errors are retryable`() {
        ...
        assertTrue(RetryPolicy.isRetryableNotifyError(NowDoingTimeoutException("read")))
        assertTrue(RetryPolicy.isRetryableNotifyError(NowDoingConnectException("connection refused: Connection refused")))
