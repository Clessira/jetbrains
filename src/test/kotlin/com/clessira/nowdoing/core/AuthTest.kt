...
class AuthTest {
    ...
    fun `golden vector - POST branch-changed with JSON body`() {
        val body = """{"repo":"NowDoingMac","repoPath":"/Users/x/dev/NowDoingMac","branch":"feature/x","previousBranch":"main"}"""
            .toByteArray(Charsets.UTF_8)
        assertEquals(
            "64b93a536478efbc09586ddef6835ec7985f0de5703d1e654f96eb8e2d14cf48",
    ...
    fun `gson serializes BranchChangeBody exactly like JSON stringify`() {
        val body = BranchChangeBody(
            repo = "NowDoingMac",
            repoPath = "/Users/x/dev/NowDoingMac",
            branch = "feature/x",
            previousBranch = "main",
        )
        assertEquals(
            """{"repo":"NowDoingMac","repoPath":"/Users/x/dev/NowDoingMac","branch":"feature/x","previousBranch":"main"}""",
